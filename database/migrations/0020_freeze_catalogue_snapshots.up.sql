...
ALTER TABLE checklist_item_progress
    ADD COLUMN IF NOT EXISTS item_text_snapshot VARCHAR(250);
...
ALTER TABLE issue_list
    ADD COLUMN IF NOT EXISTS defect_part_name_tr VARCHAR(120),
    ADD COLUMN IF NOT EXISTS defect_type_name_tr VARCHAR(120),
    ADD COLUMN IF NOT EXISTS defect_part_name_en VARCHAR(120),
    ADD COLUMN IF NOT EXISTS defect_type_name_en VARCHAR(120);
